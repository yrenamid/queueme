    ...
    <ion-content fullscreen>
      ...
      <div v-if="activeTab === 'overview'">
        ...
        <div class="grid grid-cols-3 gap-3 mx-3 mb-5">
          <CurrentOverview v-show="showCurrentOverview" :is-service-based="true" :settings-summary="settingsSummary" />
          <RecentActivity />
        </div>
      </div>
      ...
      <div v-else-if="activeTab === 'queueManagement'">
        ...
        <div class="grid grid-cols-3 my-5 mx-3 gap-4">
          ...
          <CurrentOverview v-show="showCurrentOverview" :is-service-based="true" :settings-summary="settingsSummary" @summary="onOverviewSummary" @baselines="onBaselines" />
        </div>
      </div>
...
export default {
  ...
  } catch (e) { console.debug('[service-admin] failed to access localStorage for adminActiveTab', e); }
    watch(activeTab, (tab) => {
  ...
  } catch(err) { console.debug('[service-admin] operation failed', err); }
      });
  } catch (err) { console.debug('[service-admin] error during cleanup', err); }
