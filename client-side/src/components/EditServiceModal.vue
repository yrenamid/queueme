...
// Initializes component state and handlers
  ...
  saveChanges(){ if(!this.isValid) return; this.$emit('update-item', { ...this.localItem, price: Number(this.localItem.price), duration: Number(this.localItem.duration) }); this.close(); }
  }
};
</script>
<style scoped>
